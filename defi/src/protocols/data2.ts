...
*/
  ...
  },
  {
    ...
    symbol: "WEFI",
    url: "https://wefi.xyz",
    description: " WeFi is an insured perpetual leverage trading protocol on multiple chains. The protocol allows lenders to invest in single sided liquidity pools and earn interest and leverage traders to borrow upto 20x to invest in crypto assets at 80% less funding rate. WeFi also alleviates common pain points like substantial slippage, and sudden liquidation events through its platform.",
    chain: "Polygon",
