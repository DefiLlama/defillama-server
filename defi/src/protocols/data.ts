...
const data: Protocol[] = [
  ...
  },
  {
    ...
    url: "https://rhino.fi/",
    description:
      "rhino.fi is your Layer 2 gateway to multi-chain DeFi. Buy, trade and invest effortlessly across all of your favourite blockchains from a single wallet. Access hundreds of tokens at the best price, without paying gas and maintaining privacy.",
    chain: "Ethereum",
