...
export default {
  ...
  "parent#pyth": {
    ...
    governanceData: {
      rights: "FULL",
      details: "Stakers are legal members of Pyth DAO LLC with full governance over treasury, protocol upgrades, council elections & constitutional amendments",
      feeSwitchStatus: "ON",
      feeSwitchDetails: "All protocol revenue flows to DAO treasury; Pythian Council executes monthly PYTH purchases using 33% of treasury balance",
    },
    holdersRevenueAndValueAccrual: {
      buybacks: "ACTIVE",
      dividends: "NONE",
      burns: "NONE",
      primaryValueAccrual: "Strategic Reserve - monthly PYTH purchases using 33% of DAO treasury balance",
    },
    tokenAlignment: {
      fundraising: "TOKEN",
      raiseDetailsLink: { label: "Raise Details", url: "https://www.pyth.network/blog/expanding-the-pyth-community-strategic-capital-and-new-builders" },
      associatedEntities: ["DAO"],
      equityRevenueCapture: "NONE",
    },
  },
  "parent#aave": {
    rights: [
