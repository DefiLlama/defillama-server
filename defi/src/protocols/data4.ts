    ...
    oraclesBreakdown: [
      {
        ...
        chains: [{ chain: "scroll", endDate: "2026-04-08" }],
      },
      {
        name: "Pyth",
        type: "Primary",
        proof: ["https://www.optimism.io/blog/ether.fi-is-live-on-op-mainnet"],
        chains: [{ chain: "optimism", startDate: "2026-04-08" }],
      },
    ],
    dimensions: {
