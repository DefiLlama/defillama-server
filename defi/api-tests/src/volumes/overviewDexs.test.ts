...
describe('Volumes API - Overview DEXs', () => {
  let overviewResponse: ApiResponse<VolumeOverviewResponse>;
  let chainResponse: ApiResponse<VolumeOverviewResponse>;

  beforeAll(async () => {
    const [r1, r2] = await Promise.all([
      apiClient.get<VolumeOverviewResponse>(endpoints.VOLUMES.OVERVIEW_DEXS),
      apiClient.get<VolumeOverviewResponse>(endpoints.VOLUMES.OVERVIEW_DEXS_CHAIN('ethereum')),
    ]);
  ...
  describe('All DEXs Overview', () => {
    describe('Basic Response Validation', () => {
      ...
      it('should have protocols array with data', () => {
        ...
        expect(overviewResponse.data.protocols.length).toBeGreaterThan(10);
      });
    ...
    describe('Data Quality Validation', () => {
      ...
      it('should have protocols sorted by volume', () => {
        const protocolsWithVolume = overviewResponse.data.protocols
          .filter((p) => p.total24h !== null && p.total24h !== undefined && Number(p.total24h) > 1000)
          .slice(0, 20);
    ...
    describe('Protocol Item Validation', () => {
      ...
      it('should have valid volume metrics when present', () => {
        ...
        expect(protocolsWithVolume.length).toBeGreaterThan(0);
      ...
      it('should have valid chains arrays when present', () => {
        ...
        expect(protocolsWithChains.length).toBeGreaterThan(0);
  ...
  describe('Specific Chain DEXs Overview', () => {
    describe('Basic Response Validation', () => {
      it('should return successful response with valid structure', () => {
    ...
    describe('Data Quality Validation', () => {
      it('should have protocols with data', () => {
        expect(chainResponse.data.protocols.length).toBeGreaterThan(5);
      });
      ...
      it('should have protocols for the correct chain', () => {
