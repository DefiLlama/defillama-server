...
export const RWA = {
  ...
  CHART_BY_CHAIN_ASSET_BREAKDOWN: (chain: string) => `/chart/chain/${chain}/asset-breakdown`,
  CHART_ASSET: (id: string) => `/chart/asset/${id}`,
  CHART_BY_CATEGORY: (category: string) => `/chart/category/${category}`,
  CHART_BY_CATEGORY_ASSET_BREAKDOWN: (category: string) => `/chart/category/${category}/asset-breakdown`,
  CHART_BY_PLATFORM: (platform: string) => `/chart/platform/${platform}`,
  CHART_BY_PLATFORM_ASSET_BREAKDOWN: (platform: string) => `/chart/platform/${platform}/asset-breakdown`,
  CHART_BY_ASSET_GROUP: (assetGroup: string) => `/chart/assetGroup/${assetGroup}`,
  CHART_BY_ASSET_GROUP_ASSET_BREAKDOWN: (assetGroup: string) => `/chart/assetGroup/${assetGroup}/asset-breakdown`,
  RWA_BY_ID: (id: string) => `/rwa/${id}`,
  ASSET_BY_TICKER: (ticker: string) => `/asset/${ticker}`,
  CATEGORY: (category: string) => `/category/${category}`,
  ASSET_GROUP: (assetGroup: string) => `/assetGroup/${assetGroup}`,
  CHAIN: (chain: string) => `/chain/${chain}`,
  FLOWS: (id: string) => `/flows/${id}`,
} as const;
...
export const RWA_PERPS = {
  ...
  STATS: '/stats',
  ID_MAP: '/id-map',
  MARKET_BY_ID: (id: string) => `/market/${id}`,
  CONTRACT: (contract: string) => `/contract/${contract}`,
  VENUE: (venue: string) => `/venue/${venue}`,
  CATEGORY: (category: string) => `/category/${category}`,
  ASSET_GROUP: (assetGroup: string) => `/assetGroup/${assetGroup}`,
  CHART_BY_ID: (id: string) => `/chart/${id}`,
  CHART_BY_VENUE: (venue: string) => `/chart/venue/${venue}`,
  CHART_BY_CATEGORY: (category: string) => `/chart/category/${category}`,
  CHART_OVERVIEW_BREAKDOWN: '/chart/overview-breakdown',
  CHART_CONTRACT_BREAKDOWN: '/chart/contract-breakdown',
  FUNDING: (id: string) => `/funding/${id}`,
} as const;
