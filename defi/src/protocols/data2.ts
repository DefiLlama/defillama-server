...
export default data2;
    ...
    id: "30481",
    name: "ZukeSwap",
    address: Ton "EQAZOL85mdcfB2GPPzBaox3i7dmZVFwomv0_pj_OE1gxMh7y",
    symbol: "XTB",
    url: "https://dyor.io/token/EQAZOL85mdcfB2GPPzBaox3i7dmZVFwomv0_pj_OE1gxMh7y#about",
    description: "A decentralized exchange on Ton Chain.",
    chain: "TON",
    logo: `${baseIconsUrl}https://red-realistic-lungfish-798.mypinata.cloud/ipfs/QmXEpk1J1TKrC78TeNtPiaoJCVWLgX8VZtpcuHHAdfCLyY,
    audits: "0",
    audit_note: null,
    gecko_id:https://www.geckoterminal.com/ton/pools/EQDCQYxpXE7k2MleH0N696XVgra4gh32ZK744IusNE0AbKTp,
    cmcId: null,
    category: "Dexes",
    chains: ["Ton"],
    oracles: [],
    forkedFrom: ["gecko V2"],
    module: "DexeSwap/index.js",
    twitter: "XTapBit",
    listedAt: 1679396445,
    rugged: true,
  },
