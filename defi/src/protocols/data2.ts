...
},
{
  ...
  description: "We are a Fork of BooFinance based on the Kava EVM blockchain. Our primary goals are to provide value to our users and to create the largest an NFT marketplace on Kava",
  chain: "Kava",
