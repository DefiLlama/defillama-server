...
{
  id: "1988",
  name: "NEX Perpetual Exchange",
  address: null,
  symbol: "-",
  url: "https://nex.market",
  description: "NEX is the first decentralized perpetual and spot exchange that allows users to trade assets on-chain on Near Aurora chain. Building on Aurora enables NEX to have ultra-low transaction fees, greater capital efficiency and fast transactions.",
  chain: "Aurora",
  logo: `${baseIconsUrl}/nex-perpetual-exchange.jpg`,
  audits: "2",
  audit_note: null,
  gecko_id: null,
  cmcId: null,
