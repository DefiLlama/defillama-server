...
// Protocol schema for new-users overview responses
export const newUsersProtocolSchema = z.object({
  name: z.string(),
...
export const newUsersOverviewResponseSchema = z.object({
  protocols: z.array(newUsersProtocolSchema).optional(),
...
export const newUsersSummaryResponseSchema = z.object({
  id: z.string().optional().nullable(),
  name: z.string(),
