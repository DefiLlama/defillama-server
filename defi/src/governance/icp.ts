...
export async function update_internet_computer_cache(cache:GovCache):Promise<GovCache>{
  ...
  let latest_nns_proposal_in_cache = nns_proposals_in_cache.length > 0? parseInt(nns_proposals_in_cache[nns_proposals_in_cache.length-1]):3
