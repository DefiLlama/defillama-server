...
const config = {
  uniswap: { endpoint: 'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/A3Np3RQbaBA6oKJgiwDJeo5T3zrYfGHPWFYayMwtNDum', chain: 'ethereum' },
  sushiswap: [
    { endpoint: 'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/6NUtT5mGjZ1tSshKLf5Q3uEEJtjBZJo1TpL5MXsUBqrT', chain: 'ethereum', factory: '0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac', },
    { endpoint: 'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/8nFDCAhdnJQEhQF3ZRnfWkJ6FkRsfAiiVabVn4eGoAZH', chain: 'arbitrum', factory: sushiFactory, },
    { endpoint: 'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/8NiXkxLRT3R22vpwLB4DXttpEf3X1LrKhe4T1tQ3jjbP', chain: 'polygon', factory: sushiFactory, },
    { endpoint: 'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/6VAhbtW5u2sPYkJKAcMsxgqTBu4a1rqmbiVQWgtNjrvT', chain: 'avax', factory: sushiFactory, },
    { endpoint: 'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/4a8hcsttqsmycmmeFcpffGMZhBDU4NhHfyHH6YNcnu7b', chain: 'xdai', factory: sushiFactory, },
    { chain: 'moonriver', factory: sushiFactory, },
    { endpoint: 'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/GPRigpbNuPkxkwpSbDuYXbikodNJfurc1LCENLzboWer', chain: 'bsc', factory: sushiFactory, },
  ],
  ...
  spookyswap: { chain: 'fantom', factory: '0x152ee697f2e276fa89e96742e9bb9ab1f2e61be3', endpoint: "https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/HyhMfT7gehNHMBmFiExqeg3pDtop9UikjvBPfAXT3b21" },
