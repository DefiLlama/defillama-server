...
The eWIT token is a custodial, wrapped version of the Witnet coin managed by the WitSwap plaform. The token is minted by the WitSwap team whenever someone wants to convert WIT coins to eWIT tokens and kept in custody. A user on the Ethereum network can also opt to swap his eWIT tokens back to WIT coins. The intent of this token is to allow decentralized trading on Ethereum DEXs and, in the future, to pay independent bridge operators with it if they choose to accept it.`,
  ...
  },
  {
    ...
    cmcId: "5794",
    category: "Cross Chain",
    chains: ["Ethereum","EOS","Telos","Binance","Polygon", "Fantom"],
    module: "pnetwork.js",
  ...
  },
  {
    ...
    cmcId: "1412",
    category: "Dexes",
    chains: ["Binance", "Polygon", "Ethereum", "Harmony", "Tron", "Icon", "Ontology", "IoTeX", "Bittorrent", "Avalanche"],
...
},
{
  ...
  description: "Starstream is a suite of products providing yield aggregation, yield generation and one-click smart contracts on the Metis L2 rollup. The protocol is maintained by various developers and is governed by STARS holders.",
  chain: "Metis",
  logo: `${baseIconsUrl}/starstream.png`,
  audits: "2",
  audit_note: null,
  gecko_id: "starstream",
  cmcId: null,
