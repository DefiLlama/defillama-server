...
    referralUrl: "https://app.rysk.finance/join?code=DEFILLAMA",
  ...
  */
  ...
  },
  {
    ...
    description: "WSwap is a decentralized exchange on WChain with liquidity pools and token swaps.",
    chain: "WChain",
    logo: `${baseIconsUrl}/wswap.png`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["AMM"],
    chains: ["WChain", "Ethereum", "Binance"],
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: "https://app.w-swap.com/#/bridge",
    description:
      "WSwap Bridge tracks bridge collateral locked across Ethereum and Binance for transfers to WChain.",
    chain: "WChain",
    logo: `${baseIconsUrl}/wswap-bridge.png`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "Bridge",
