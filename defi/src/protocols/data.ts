...
},
{
  ...
  description: "REDACTED Cartel is an initiative using the POL mechanics of OlympusDAO to accumulate as much liquidity as possible from the Curve ecosystem in order to have a majority say over the Curve gauge.",
  chain: "Ethereum",
