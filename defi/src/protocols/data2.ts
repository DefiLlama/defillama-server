...
const data2: Protocol[] = [
  ...
  */
  ...
  },
  {
    id: "1541",
    name: "Wormhole",
    previousNames: ["Wormhole", "Portal"],
    address: "solana:85VBFQZC9TZkfaptBWjvUw7YbZjy52A6mjtPGjstQAmQ",
    symbol: "W",
    url: "https://wormhole.com/",
    description: "An interoperability platform powering multichain apps and bridges",
    chain: "Solana",
    logo: `${baseIconsUrl}/wormhole.jpg`,
    audits: "2",
    audit_note: null,
    gecko_id: "wormhole",
    cmcId: "29587",
    category: "Bridge",
    chains: ["Ethereum","Solana","Algorand","Aptos","Arbitrum","Avalanche","Base","Berachain","BNB Smart Chain","Celestia","Celo","Converge","Cosmos Hub","CreditCoin","Dymension","Evmos","Fantom","Fogo","HyperCore","HyperEVM","Injective","Ink","Kaia","Kujira","Linea","Mantle","Mezo","Monad","Moonbeam","NEAR","Neutron","Noble","Optimism","Osmosis","Plasma","Plume","Polygon","Provenance","Pythnet","Scroll","SEDA","Sei","Seievm","Sonic","Stacks","Stargaze","Sui","Unichain","World Chain","X Layer","XRPL-EVM"],
    forkedFrom: [],
    module: "wormhole.js",
    twitter: "wormhole",
    audit_links: ["https://github.com/wormhole-foundation/wormhole-audits", "https://github.com/wormhole-foundation/wormhole/tree/main/audits"],
    listedAt: 1647148275,
