...
const data: Protocol[] = [
  ...
  },
  {
    ...
    description:
      "Synthetix is a derivatives liquidity protocol providing the backbone for derivatives trading in DeFi.(Ethereum network)",
    chain: "Ethereum",
    logo: `${baseIconsUrl}/synthetix-v1.png`,
    audits: "2",
    audit_note: null,
    gecko_id: null,
    cmcId: null,
