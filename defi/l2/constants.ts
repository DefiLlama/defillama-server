...
// export const gasTokens: { [chain: Chain]: { ticker: string; cgid?: string } } = {
//   bitcoin: { ticker: "BTC" },
//   ronin: { ticker: "RON" },
//   near: { ticker: "NEAR" },
//   pulsechain: { ticker: "PLS" },
//   rootstock: { ticker: "RBTC" },
//   stacks: { ticker: "STX" },
//   fantom: { ticker: "FTM" },
...
//   bsc: { ticker: "BNB" },
//   tron: { ticker: "TRON" },
//   zklink: { ticker: "ZKLINK" },
//   rss3_vsl: { ticker: "RSS3" },
//   kinto: { ticker: "KINTO" },
//   blast: { ticker: "ETH" },
//   mode: { ticker: "ETH" },
// };
