...
    referralUrl: "https://app.primevaults.finance?referral_code=REF0b09139d",
  ...
  },
  {
    ...
    description:
      "Quell is an ERC-4626 USDC yield vault on Arbitrum that routes deposits into the Spark sUSDC vault for RWA-backed yield via Sky Savings Rate. Net APY ~4.5% after 0.2% management fee + 10% performance fee. Fees are split 60/40 between QUELL token stakers and treasury",
    chain: "Arbitrum",
