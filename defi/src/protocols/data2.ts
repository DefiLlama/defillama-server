...
},
{
  ...
  description:
    "FlokiFi Locker is the industry's most innovative protocol for securing digital assets. Securely lock Liquidity Pool (LP) tokens, NFTs, fungible tokens, and Multi-tokens in just a few clicks.",
  chain: "Ethereum",
