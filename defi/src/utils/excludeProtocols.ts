...
export const hiddenCategoriesFromUISet = new Set(["CEX", "Chain"]) // hide these categories on defillama.com/categories page
export const hiddenCategoriesFromProtocolsListSet = new Set(["Chain", "CEX", 'Canonical Bridge']) // hide protocols with these categories on defillama.com home page , api.llama.fi/lite/protocols2 endpoint