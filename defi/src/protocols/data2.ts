...
const data2: Protocol[] = [
  ...
  */
  ...
  },
  {
    ...
    chains: ["Klaytn"],
    oracles: [],
    forkedFrom: ["Uniswap V2", "SushiSwap"],
  ...
  },
  {
    ...
    chains: ["Evmos"],
    oracles: [],
    forkedFrom: ["Uniswap V2", "PancakeSwap"],
...
*/
  ...
  */
  ...
  },
  {
    ...
    description: "The Ethereum Liquid Staking Index Token ixETH is backed by a diversified basket of the leading Ethereum staking protocols and their Liquid Staking Derivatives (LSDs). Simply deposit any supported ETH LSD and mint ixETH to receive a blended return from the underlying protocols, plus withdrawal fees.",
    chain: "Ethereum",
    logo: `${baseIconsUrl}/ixeth-index.png`,
    audits: "0",
    audit_note: null,
    gecko_id: null,
    cmcId: null,
