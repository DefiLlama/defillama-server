...
export default [
{
  ...
  },
  {
    id: "1469",
    name: "AlgoFi",
    address: "algorand:469835031",
    symbol: "BANK",
    url: "https://www.algofi.org",
    description: "The Algofi platform allows Algorand users to lend and borrow to earn interest, get leverage, or short crypto assets.",
    chain: "Algorand",
    logo: `${baseIconsUrl}/algofi.png`,
    audits: "2",
    audit_note: null,
    gecko_id: null,
    cmcId: null,
