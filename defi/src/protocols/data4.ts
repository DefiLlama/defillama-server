...
const data4: Protocol[] = [
  ...
  */
  ...
  },
  {
    ...
    twitter: "SoleraLabs",
    oraclesBreakdown: [ { name: "Stork", type: "Primary", proof: [] }, { name: "eOracle", type: "Secondary", proof: ["https://docs.solera.market/overview/editor/oracles"] }, ], // https://github.com/DefiLlama/DefiLlama-Adapters/pull/13350
    forkedFromIds: ["1599"],
    audit_links: [
