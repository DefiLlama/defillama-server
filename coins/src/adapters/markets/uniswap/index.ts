...
const config = {
  ...
  sushiswap: [
    { chain: 'ethereum', factory: '0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac', },
    { chain: 'arbitrum', factory: sushiFactory, },
    { chain: 'polygon', factory: sushiFactory, },
    { chain: 'avax', factory: sushiFactory, },
    { chain: 'xdai', factory: sushiFactory, },
    { chain: 'moonriver', factory: sushiFactory, },
    { chain: 'bsc', factory: sushiFactory, },
  ],
