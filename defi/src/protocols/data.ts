...
const data: Protocol[] = [
  ...
  */
  ...
  },
  {
    ...
    description: "OnX Finance is a yield aggregating platform specifically designed for yield generating tokens such as liquid staking, LP tokens, and vault tokens to unlock new yield opportunities combining vaults and lending.",
    chain: "Ethereum",
...
*/
  ...
  },
  {
    ...
    twitter: "ApeRocketFi",
    audit_links: ["https://github.com/peckshield/publications/blob/master/audit_reports/PeckShield-Audit-Report-ApeRocket-v1.0.pdf"], 
  },
  {
    id: "402",
    name: "Hunny Finance",
  ...
  },
  {
    ...
    audit_links: ["https://certificate.quantstamp.com/full/naos-formation", "https://www.certik.com/projects/naosfinance"],
  },
  {
    id: "416",
    name: "WeStarter",
...
The eWIT token is a custodial, wrapped version of the Witnet coin managed by the WitSwap plaform. The token is minted by the WitSwap team whenever someone wants to convert WIT coins to eWIT tokens and kept in custody. A user on the Ethereum network can also opt to swap his eWIT tokens back to WIT coins. The intent of this token is to allow decentralized trading on Ethereum DEXs and, in the future, to pay independent bridge operators with it if they choose to accept it.`,
  ...
  },
  {
    ...
    audit_links: ["https://github.com/Fujicracy/fuji-protocol/blob/main/audits/Fuji_Securing_2021-07.pdf" ,
  ...
  },
  {
    ...
    description: "Yield Yak Aggregator is an easy-to-use tool to earn more yield from defi farming on the Avalanche network.",
    chain: "Avalanche",
  ...
  },
  {
    ...
    chains: ["Near"],
    module: "metapool.js",
    audit_links: ["https://370551154-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-MkhZe3MGAhTcvTLTzJF-887967055%2Fuploads%2FBnkI1s1NHp6rjw4vBsZo%2FBlocksec_Audit_2.pdf?alt=media&token=30a76ad3-a5ad-4454-87c0-0e0815b4170b"],
    twitter: "meta_pool",
  },
  {
    id: "558",
  ...
  },
  {
    ...
    description: "Allbridge is a simple, modern, and reliable way to transfer assets between different networks. It is a bridge between both EVM and non-EVM compatible blockchains, that aims to cover L2 solutions and NFT transfers in the future.",
    chain: "Celo",
  ...
  },
  {
    ...
    cmcId: "5892",
    category: "Bridge",
    chains: ["Ethereum", "Binance", "OKExChain", "xDai", "Heco", "Polygon", "Fantom", "Kucoin", "Moonriver", "Arbitrum", "Avalanche", "Harmony", "Syscoin", "Telos"],
  ...
  },
  {
    ...
    description: "Float allows you to get perpetual, leveraged exposure to any crypto asset, without worrying about liquidations or managing debt positions.",
    chain: "Polygon",
  ...
  },
  {
    ...
    description: "Arrakis is a protocol that specializes in concentrated & active liquidity management. By creating a curated marketplace of novel tokenized LP strategies, Arrakis facilitates deep liquidity and optimizes LP earnings across its vaults.",
    chain: "Ethereum",
...
},
{
  ...
  audits: "1",
  audit_links: [
    "https://omniscia.io/klimadao-algorithmic-bonding-system/",
  ],
  audit_note: null,
  gecko_id: "klima-dao",
  cmcId: "12873",
...
},
{
  ...
  cmcId: "3814",
  category: "Bridge",
  chains: ["Ethereum", "Binance", "Arbitrum", "Polygon", "xDai", "OKExChain", "Avalanche", "Optimism", "Fantom", "Heco", "Boba", "Harmony", "Aurora", "Moonbeam", "Moonriver", "Metis", "Shiden", "Celo", "Syscoin"],
...
},
{
  ...
  description: "OtterClam is a decentralized ecosystem that incorporates elements of finance, governance, and NFTs, in the Metaverse. These three components correspond to OtterClam’s Treasury, DAO, and Otter Kingdom, respectively.",
  chain: "Polygon",
...
},
{
  ...
  description: "Euphoria is an algorithmic reserve currency protocol on Harmony (ONE). The protocol intends to combine ViperSwap with Euphoria to bridge the gap between DeFi 1.0’s liquidity mining mechanisms and DeFi 2.0’s protocol-owned liquidity mechanisms",
  chain: "Harmony",
...
},
{
  ...
  symbol: "MUSE",
  url: "https://nft20.io",
  description: "Trade, swap & sell NFTs. The NFT20 protocol offers NFT liquidity pools to help developers build the next generation of NFT apps.",
  chain: "Ethereum",
...
},
{
  ...
  description: "MinMax Finance aims to be the leading cross-chain stablecoin AMM on IoTeX. Built on top of Saddle, MinMax is the first next generation stablecoin AMM protocol on IoTeX. MinMax provides the liquidity foundation for all kind of stablecoins. As IoTeX ’s core cross-chain liquidity network, MinMax helps facilitate the transfer of assets between IoTeX and other blockchains. Users deposit crypto assets into our IoTeX liquidity pools to earn passive yield from transaction fees, token-based incentives, and eventually automated DeFi strategies.",
  chain: "IoTeX",
...
},
{
  ...
  description: "Layer2.Finance is a layer-2 scaling technology that acts as a low-cost and trust-free gateway for users to explore and benefit from the existing DeFi ecosystem without the concerns of high transaction (gas) costs offsetting their gains.",
  chain: "Ethereum",
...
},
{
  ...
  twitter: "bscstation",
  audit_links: ["https://www.certik.org/projects/bscstation",
...
},
{
  ...
  description: "CronaSwap is a decentralized exchange platform for swapping ERC-20 tokens on the Cronos Chain network.",
  chain: "Cronos",
...
},
{
  ...
  description: "ArenaSwap is a decentralized exchange platform built on BSC (Binance Smart Chain) that focuses on gamification of yield farming and gambling.",
  chain: "Binance",
  ...
  twitter: "arenaswap",
  audit_links: ["https://rugdoc.io/project/arenaswap/",
...
},
{
  ...
  audit_links: ["https://static.bunnypark.com/image/BunnyPark/pdf/SlowMistAuditReportBunnyPark-en.pdf",
...
},
{
  ...
  description: "SWAPP Protocol is a decentralized, fairly launched, ETH-paired utility token used to both facilitate yield farming rewards in the Swapp DeFi platform as well as serve as the form of rewards within the Swapp smartphone app (on ios and android).",
  chain: "Cronos",
...
},
{
  ...
  description: "Matrix is a Farm Aggregator that helps users to simplify their experience on the Fantom vast ecosystem. Indeed, being a Farm Aggregator, Matrix allows users to easily stake their FTM within different liquidity pools.",
  chain: "Fantom",
...
},
{
  ...
  description: "Unirex Finance is a decentralized farm yield project running on Fantom Chain, Polygon (soon), and BSC (soon).",
  chain: "Fantom",
...
},
{
  ...
  description: "Talent Protocol is a web3 platform where talent can easily launch a social token (called Talent Tokens) to accelerate their career, and where supporters can back people they believe in.",
  chain: "Celo",
...
},
{
  ...
  description: "Capital DAO Protocol is the First Decentralized Venture Capital Using DAO for MultiChain. It disrupts Venture 2.0 and moves to Venture 3.0",
  chain: "Ethereum",
...
},
{
  ...
  description: "Polyroll is a decentralized gaming platform built on Polygon Network and Chainlink. Unlike traditional games that operate in black boxes, Polyroll runs on smart contracts that are fair, transparent, non-custodian, and immutable.",
  chain: "Polygon",
...
},
{
  ...
  description: "Demeter is a multi-chain deployment decentralized currency market protocol (DUSD). Combining collateralized lending and collateralized stablecoin generation, Demeter provides a more secure lending service at a lower cost",
  chain: "Heco",
  ...
  module: "demeter.js",
  twitter: "Demetervip",
  audit_links: ["https://github.com/peckshield/publications/blob/master/audit_reports/PeckShield-Audit-Report-Demeter-v1.0.pdf"],
  forkedFrom: ["Compound"],
  listedAt: 1637123250,
},
{
...
},
{
  ...
  description: "FortuneDAO is the first is a decentralized reserve currency on Cronos network. Using our treasury, we will farm, buy and accumulate native tokens in Cronos. As stated repeatedly, this will help support the Cronos ecosystem and also allows us to become a blackhole for Cronos.",
  chain: "Cronos",
...
},
{
  ...
  description: "SDOG is a decentralized reserve currency that will last 8 days. Are you ready? Available on #Avalanche. A SnowbankDAO company.",
  chain: "Avalanche",
...
},
{
  ...
  description: "Bear Finance is a reserve Defi protocol that produces BEAR tokens: backed by value and powered by yield farming.",
  chain: "Fantom",
...
},
{
  ...
  description: "Saffron is a protocol for tokenizing on-chain assets, including contracts that otherwise impair access to utilized capital.",
  chain: "Ethereum",
...
},
{
  ...
  description: "A platform that allows two projects to certify their partnership and connects single-sided Liquidity Pool funding on Uniswap by matching providers.",
  chain: "Ethereum",
...
},
{
  ...
  symbol: "DFL",
  url: "https://defily.io/#/",
  description: "Defily is the first-ever cross-chain Decentralized Finance project on KardiaChain, which will soon bridge to Ethereum, Binance Smart Chain, Harmony, Avalanche, and Tomochain. Defily focuses on bringing DeFi to everyone in a fun and an easy to understand way!",
  chain: "Kardia",
...
},
{
  ...
  description: "MintSwap, a new Stable DeFi Token on Avax Network which helps investors to protect their funds as we provide a transparent environment so that users can use our services worry-free and helps to bring in stable passive income by staking!",
  chain: "Avalanche",
...
},
{
  ...
  description: "Skeleton Finance is a yield optimizer on Fantom Opera. Users can deposit various tokens and get their yield auto-compounded. SKULL token is given as bonus reward on top of their yield. SKULL token is native yield farming token to Skeleton.finance. SKULL holders receive protocol fees and will be able to vote on protocol changes.",
  chain: "Fantom",
...
},
{
  ...
  description: "ICHI deploys a branded dollar for any cryptocurrency community. This enables retail on-boarding, protocol growth, and ecosystem acceleration.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Yield Protocol brings collateralized fixed-rate,fixed-term borrowing and lending and interest rate markets to decentralized finance.",  
  chain: "Ethereum",
...
},
{
  ...
  description: "DungeonSwap is a decentralized table-top RPG style web game on the Binance Smart Chain with play-to-earn, yield farming features and NFTs.",
  chain: "Binance",
...
},
{
  ...
  description: "MarshmallowDeFi (MASH) is the next generation of Automated Market Making (AMM) decentralized exchange with a deflationary governance token model. We are your go-to yield farm running on Binance Smart Chain",
  chain: "Binance",
...
},
{
  ...
  description: "The most popular AMM on BSC! Earn CORIS through yield farming, then stake it in Pools to earn more tokens! I, NFTs, Wallet and more",
  chain: "Binance",
...
},
{
  ...
  description: "Revault aims to become the Google search of Defi. Revault was born to solve the two major pains in Defi - finding the right place (including risk) to invest your assets, and maintaining that position to always be on optimum.",
  chain: "Binance",
  ...
  },
  {
    ...
    description: "SmolSwap is the cutest fair launch decentralised trading platform on the Cronos chain where you can trade and earn in a safe, simple, and fun manner.",
    chain: "Cronos",
  ...
  },
  {
    ...
    module: "paraswap.js",
    twitter: "paraswap",
    audit_links: ["https://github.com/solidified-platform/audits/blob/master/Audit%20Report%20-%20ParaSwap%20%5B20.01.2021%5D.pdf"],
    listedAt: 1637654600,
  },
  {
    id: "895",
    ...
    description: "BlackPool is a new fund operating within the NFT industry: managing a range of assets from sports cards to game items to digital art. BlackPool is the first DAO built solely for NFT gaming and trading.",
    chain: "Ethereum",
  ...
  },
  {
    ...
    description: "Kwikswap is a revolutionary Multi Cross Chain Swap Protocol with Layer 2 Scaling powered by Ethereum, Polkadot, Shiden, Astar (formerly Plasm), Reef Chain, BSC & Acala Network. Use Kwikswap for Swapping, Market Creation, Provide Liquidity & Staking",
    chain: "Ethereum",
  ...
  },
  {
    ...
    description: "Money Market Protocol and the Oracle for Korea’s Digital Asset Market(detailed in https://docs.donkey.fund/about/whitepaper/english-whitepaper)",
    chain: "Klaytn",
  ...
  },
  {
    ...
    description: "BeGlobal.finance aims to be your preferred DeFi site offering trading (swaps), optimizer (auto-compound), NFTs with multiple utilies and highest yields vaults, among with other features that will be released in the near future.",
    chain: "Binance",
  ...
  },
  {
    ...
    description: "Everest DAO is building an ecosystem of intriguing Dapps on Avalanche, bringing an authentic and unmatched experience, no matter your skill or knowledge.",
    chain: "Avalanche",
  ...
  },
  {
    ...
    forkedFrom: ["Uniswap"],
    audit_links: [
      "https://www.hswap.com/slowmist-zh.pdf",
      "https://www.hswap.com/lianan-zh.pdf",
    ],
    listedAt: 1637724237,
  },
  {
    ...
    description: "We introduce MiniSwap to enable a connected network of DeFi ecosystems. MiniSwap provides a decentralised platform for exercising financial products.",
    chain: "Ethereum",
  ...
  },
  {
    ...
    description: "NFT oriented DEX on Cronos Chain. Trade, farm, earn and now stake your owned NFTs from several Cronos projects.",
    chain: "Cronos",
  ...
  },
  {
    ...
    description: "Developed Single infrastructure which will allow various assets , liquidity to move from one chain to another seamlessely as well enable liquidity staking for DPoS assets",
    chain: "Ethereum",
  ...
  },
  {
    ...
    description: "Golff is positioned as a one-stop services encrypted bank, committing to creating a light, open and free financial world where everyone can participate.",
    chain: "Ethereum",
  ...
  },
  {
    ...
    description: "The Sumswap unites decentralized protocols whose synergy enables the most lucrative, fastest and protected operations in the DeFi space.",
    chain: "Ethereum",
  ...
  },
  {
    ...
    description: "Defrost Finance is a decentralized protocol that allows you to leverage yield-bearing Tokens or other pool tokens from Avalanche and cross-chain protocols as collaterals for generating H2O, a USD-pegged stablecoin.",
    chain: "Avalanche",
  ...
  },
  {
    ...
    description: "Definix is the transparent crypto investment platform on a multi-chain, with useful features that allows professional traders to earn more from their investing skills by creating and managing their own funds.",
    chain: "Binance",
  ...
  },
  {
    ...
    symbol: "PACOCA",
    url: "https://pacoca.io",
    description: "Paçoca is a portfolio manager where users can track their DeFi assets, invest in smart vaults with compounding yields, and trade tokens at the best rates using the decentralized exchange aggregator.",
    chain: "Binance",
  ...
  },
  {
    ...
    description: "Big Data Protocol tokenizes commercially valuable data through a network of 14,141 professional data providers and makes the data token liquid on Uniswap. Users earn data by providing liquidity to data tokens.",
    chain: "Ethereum",
  ...
  } ,
  {
    ...
    description: "PIDAO is a decentralized reserve currency protocol based on the PID token and aims at building a community-owned decentralized financial infrastructure for the crypto world" ,
    chain: "Binance" , 
  ...
  },
  {
    ...
    description: "FreeLiquid is a decentralized lending platform that offers funding in $USDFL stablecoins to liquidity providers" ,
    chain: "Ethereum" ,
  ...
  "https://paladinsec.co/projects/polyshield" ,
  "https://rugdoc.io/project/polyshield-finance" 
  ...
  },
  {
    ...
    description: "ARCx is a decentralized scoring protocol that powers on-chain identity through the issuance of a DeFi Passport. The first element in the DeFi Passport is an on-chain credit score, which is issued to an identity based on an assessment of the address’ on-chain activity" ,
    chain: "Ethereum" ,
  ...
  },
  {
    ...
    description: "Retreeb is the first distributed payment solution that shares one third of its network fees to funding social and solidarity project",
    chain: "Fantom" ,
  ...
  },
  {
    ...
    description: "MoonDao is a decentralized reserve currency protocol based on the MD token. Each MD token is backed by a basket of assets (e.g. DAI, USDC) in the MoonDao treasury, giving it an intrinsic value that it cannot fall below.",
    chain: "Moonriver",
  ...
  },
  {
    ...
    description: "Cerberus is a decentralized reserve currency protocol launching under the 3DOG (🐶,🐶,🐶) token. Each 3DOG token is backed by a basket of assets, starting with meme coins, e.g. Shiba Inu (SHIB), Ethereum (wETH), and, eventually, stablecoins (DAI)",
    chain: "Ethereum",
  ...
  },
  {
    ...
    description: "Xeus Finance is a decentralized finance reserve currency protocol built on Binance Smart Chain (BSC). The protocol is powered by the $XEUS token, which is backed by a basket of assets like BUSD, LPs, etc.",
    chain: "Binance",
  ...
  },
  {
    ...
    description: "TaiChi is a decentralized reserve currency protocol available on the BSC (Binance Smart Chain) network based on the TAC token. Each TAC token is backed by a basket of assets (e.g., BUSD, BUSD-TAC LP, wBNB, etc.)",
    chain: "Binance",
  ...
  },
  {
    ...
    description: "Omicron is a decentralized reserve currency protocol available on the Arbitrum Network based on the OMIC token. Each OMIC token is backed by a basket of assets (e.g. MIM, OMIC-MIM LP) in the OMIC treasury, giving it an intrinsic value that it cannot fall below.",
    chain: "Arbitrum",
  ...
  },
  {
    ...
    description: "Tornadao is a decentralized reserve currency protocol available on the Avalanche (AVAX) Network based on the NADO token. Each NADO token is backed by a basket of assets (initially with MIM, and MIM/NADO) in the Tornadao treasury",
    chain: "Avalanche",
  ...
  },
  {
    ...
    description: "ChickenSwap DEX is a Decentralized Exchange, similar to Uniswap. All users can provide liquidity and trade crypto assets here without any centralized orderbook.",
    chain: "Ethereum",
  ...
  },
  {
    ...
    description: "PartySwap is an application focused on bringing liquidity to the Avalanche Ecosystem through different activities starting with an AMM (Automated Market Maker)",
    chain: "Avalanche",
  ...
  },
  {
    ...
    description: "KafeFinance is a cross-chain yield optimizer that provides a single platform to auto-compound farms from a variety of projects on MoonRiver and Cronos. KafeFinance has also expanded the platform to include tools such as a portfolio dashboard and zapper.",
    chain: "Moonriver",
  ...
  },
  {
    ...
    description: "Mobius Finance is the first multi-collateral decentralized trading protocol that allows users to create and trade synthetic assets with zero slippage, built on top of Polygon",
    chain: "Polygon",
  ...
  },
  {
    ...
    description: "KryptoDEX is powered by InterDeFi with many winning components: a DEX with a very attractive trading fee, a launchpad with great IDO track record, a NFT marketplace, unique 3-type referral system and more.",
    chain: "Cronos",
  ...
  },
  {
    ...
    description: "DeFi yield customizer. Deposit liquidity, choose what you want to earn your yields in. Live on Avalanche and Harmony.",
    chain: "Avalanche",
  ...
  },
  {
    ...
    description: "MidasDAO introduce #DeFiX - automated treasury growth protocol with a steady flow of revenues from Metaverse, P2E & farming that rewards $CROWN investors.",
    chain: "Avalanche",
  ...
  },
  {
    ...
    symbol: "UBQ",
    url: "https://ubq.fi",
    description: "As an organization, it is committed to becoming the bank of the metaverse, while building open-source developer tooling and community management tools to augment the operating efficiency of DAOs.",
    chain: "Ethereum",
  ...
  },
  {
    ...
    description: "LifeDAO is a decentralised, reserve currency protocol built on the Avalanche network by the LifeDAO team. The LF (Also sometimes called LIFE) token is the protocol's main asset.",
    chain: "Avalanche",
  ...
  },
  {
    ...
    description: "[Project abandoned by team] The highest APY yield optimization strategies for BTC, BUSD, BNB and more.",
    chain: "Binance",
  ...
  },
  {
    ...
    symbol: "PIGGY",
    url: "https://piggy.fi",
    description: "Piggy is a decentralized borrowing protocol that offers interest-free, efficiently collateralized loans backed by $BNB.",
    chain: "Binance",
  ...
  // },
  {
    ...
    description: "LUX is a decentralized reserve currency that remains unbound by a peg. Luxor is the first multi-chain, decentralized reserve currency protocol available on the Fantom Opera Network based on the LUX token.",
    chain: "Fantom",
  ...
  },
  {
    ...
    symbol: "BRC",
    url: "https://brinc.fi",
    description: "The Brinc protocol allows for the decentralized creation and governance of a token supply using a bonding curve algorithm that is hard-coded into solidity smart contracts.",
    chain: "Arbitrum",
...
*/
  ...
  },
  {
    ...
    description: "SafeSwap is a decentralized crypto-asset exchange (DEX), enabling the listing and trading of native crypto tokens.",
    chain: "Polygon",
  ...
  },
  {
    ...
    description: "CheeseDAO attempts to stand on the shoulders' of giants, whose contributions to the ecosystem put all the pieces in place necessary to launch a decentralized gamified risk protocol owned and governed by the players",
    chain: "Harmony",
  ...
  },
  {
    ...
    description: "$PAPA is a decentralized reserve currency that remains unbound by a peg - that is used in the #Metaverse. We back Metaverse & GameFi Projects.",
    chain: "Avalanche",
  ...
  },
  {
    ...
    description: "Pumpkin DAO is an decentralized reserve currency protocol available on the Fantom Network based on the PUMP token. Each PUMP token is backed by a basket of assets (e.g. FTM, DAI-PUMP LP Tokens, etc) in the PumpkinDAO treasury, giving it an intrinsic value that it cannot fall below.",
    chain: "Fantom",
  ...
  },
  {
    ...
    description: "Stargate Finance is a decentralized reserve currency protocol based on the SGT token on Binance Smart Chain. Economically, it imitates the model created by OlympusDao. ",
    chain: "Binance",
  ...
  },
  {
    ...
    description: "Atlas USV is a community-driven project to build a universal, decentralized, and widely accessible DeFi base layer.",
    chain: "Polygon",
  ...
  description: "Aztec is an open source layer 2 network bringing scalability and privacy too Ethereum. Aztec uses zkSNARK proofs to provide privacy and scaling via our zkRollup service.",
  chain: "Ethereum",
...
},
{
  ...
  description: "The Permissionless Stablecoin Minting Protocol, Mint USDO with the tokens you own. Trade USDO for the tokens you want.",
  chain: "Binance",
...
},
{
  ...
  description: "StarTerra is a Gamified LaunchPad with lottery based + guaranteed allocations, Play2Earn and NFT Integration. Through our gamification you, the investor, can strategize your way into larger allocations and be send out into Universe to conquer other planets, moons and galaxies!",
  chain: "Terra",
...
},
{
  ...
  description: "XMAS PAST brings forward the old school yield-farming style into the modern age. It offers us the redemption of one self from the rat race of real-life financial struggles, spreading the happiness in this joyous season through a safe and quality yield-farming experience.",
  chain: "Fantom",
...
},
{
  ...
  description: "The Base Protocol (BASE) is a synthetic crypto asset whose price is pegged to the total market cap (cmc) of all cryptocurrencies at a ratio of 1 : 1 trillion",
  chain: "Ethereum",
...
},
{
  ...
  description: "Bitcoin Standard Hashrate Token (or BTCST token) aims to widen up the participation of Bitcoin mining to the open market.",
  chain: "Binance",
...
},
{
  ...
  description: "Mercurity is an open DeFi platform powered by swap. The most important problems we aim to solve are: low capital utilization, impermanent loss risk, and poor community governance capabilities.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Sunflower Swap is an ETH-based NFT decentralized platform which adopts DeFi protocol. It firstly uses AMM and SLP",
  chain: "Ethereum",
...
},
{
  ...
  description: "Tempus is a multi-chain fixed income protocol. Tempus integrates with lending protocols, staking protocols, and yield aggregators, and lets users fix or speculate on the yield generated by them.",
  chain: "Ethereum",
...
},
{
  ...
  audit_links: ["https://www.meritcircle.io/Report.pdf",
...
},
{
  ...
  description: "GlobianceDEX is the first decentralized exchange built on the leading XDC (XinFin) blockchain. Developed as an Automated-market-maker (AMM) on XDC, its goal is to become a launchpad for all XRC20 tokens, facilitate instant swaps within XDC & across different chains.",
  chain: "XDC",
...
},
{
  ...
  description: "LeagueDAO is a decentralized open source project developing Tokenized Fantasy Sports and Gaming Protocols.",
  chain: "Ethereum",
...
},
{
  ...
  description: "By holding, bonding or staking $SPACE Tokens, you become a member of the DAO and your tokens are backed by a portion of the Vortex DAO Treasury.",
  chain: "Avalanche",
...
},
{
  ...
  description: "MOBOX is a cross platform gaming metaverse that combines automated optimized DeFi yield farming & gaming NFTs to create a GameFi #metaverse known as #MOMOverse",
  chain: "Binance",
...
},
{
  ...
  description: "Sheesha Finance provides a next-level multichain and community-centric DeFi mutual fund where you stake, set, and forget your tokens while collecting rewards from partner projects on the ERC20 and BEP20 chains.",
  chain: "Binance",
...
},
{
  ...
  description: "SEntropyfi is a decentralized platform that can potentially enable Defi users to amplify their yield for 10x by playing lossless games (e.g., market prediction, insurance, etc.). ",
  chain: "Polygon",
...
},
{
  ...
  description: "​CakeDao is a decentralized reserve currency protocol available on the Avalanche Network based on the CAKE token.",
  chain: "Avalanche",
...
},
{
  ...
  description: "​Earn yield on the largest protocols on Solana: All of the collateral deposited to Chest is actively staked to earn additional yield for the users. Earn yield on option strategies: Every week Chest vaults run automated call-cover and put-cover options to earn yield for its users",
  chain: "Solana",
...
},
{
  ...
  description: "We leverage the 'Best in Breed' DeFi protocols to offer decentralized investment strategies. Built on Balancer V2, Embr is the first next-generation AMM protocol on Avalanche.",
  chain: "Avalanche",
...
},
{
  ...
  audit_links: ["https://github.com/TechRate/Smart-Contract-Audits/blob/main/Thoreum.pdf",
...
},
{
  ...
  description: "An algorithmic token, $KITTY, aimed towards bringing liquidity and new use cases to the AVAX & MATIC network.",
  chain: "Avalanche",
...
},
{
  ...
  description: "SpiritDAO is a decentralized reserve currency, forked from the successful and secure Olympus DAO. Spirit will rely on the bond-and-stake methodology, in order to raise treasury funds and reward early supporters.",
  chain: "Avalanche",
...
},
{
  ...
  description: "ArbiCheems is a fun, cheeseburger-loving squishy doge modeled after a particular rainbow-cat protocol but with some notable tweaks to make it more value-oriented and integrate in the Arbi's Food Court.",
  chain: "Arbitrum",
...
},
{
  ...
  symbol: "IFT",
  url: "https://ifpool.io",
  description: "IFPool is a liquid staking pool for CSC. Users stake CET for iCET, which can be used in other DeFi protocols.",
  chain: "CSC",
...
},
{
  ...
  description: "Experience the Real Yield Farming on Fantom Protocol. Our ultimate aim is to built a stable passive earning platform to our investors and to become a well stable farm on Fantom.",
  chain: "Fantom",
...
},
{
  ...
  description: "Umbria's Narni Bridge: fastest & cheapest cross-chain liquidity bridge Ethereum & Polygon. Migrate assets almost instantly for extremely low fees",
  chain: "Ethereum",
...
},
{
  ...
  chain: "Ethereum",
  logo: `${baseIconsUrl}/everipedia.png`,
  audits: "0",
  audit_note: null,
  gecko_id: "everipedia",
  cmcId: "2930",
...
},
{
  ...
  description: "Thetanuts is a decentralized structured products protocol that helps users gain sustainable yield through various options strategies",
  chain: "Ethereum",
...
},
{
  ...
  description: "Decentralized Exchange and Automatic Liquidity Acquisition Yield Farm running currently on Binance Smart Chain" , 
  chain: "Binance",
...
},
{
  ...
  description: "Templar is the first decentralized reserve currency protocol available on the Binance Smart Chain based on the TEM token.",
  chain: "Binance",
...
},
{
  ...
  description: "Ara Finance is building a community-owned decentralized financial infrastructure to bring more stability and transparency for the world.",
  chain: "Avalanche",
...
},
{
  ...
  description: "Bourbon DAO is a decentralized reserve currency protocol based on the WHISKEY token and aims at building a community-owned decentralized financial infrastructure for the crypto world.",
  chain: "Binance",
...
},
{
  ...
  symbol: "APW",
  url: "https://apwine.fi",
  description: "Speculate on the evolution of the yield generated by different DeFi protocols. Hedge your risk on your passive revenue, converting it into futures. Tokenise the yield generated by your interest-bearing tokens. APWine splits your interest-bearing assets into Principal Tokens and Future Yield Tokens. Sell your APYs ahead of time. Claim your yield at maturity.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Join the world of permissionless DeFi by Leveraging your assets in isolated markets, where the rules are set by you and the community.",
  chain: "Polygon",
...
},
{
  ...
  symbol: "MAMA",
  url: "http://mamadao.co",
  description: "MAMA aims to become a community-owned mutual fund that sets out to help build the future of Metaverse and DeFi gaming.",
  chain: "Polygon",
...
},
{
  ...
  description: "VultureSwap is a DEX on Cronos Chain which offers token swap/trading at the lowest price on the whole Cronos Defi space.",
  chain: "Cronos",
  ...
  twitter: "VultureSwap",
  audit_links: [ "https://www.certik.com/projects/vultureswap"  ,
...
},
{
  ...
  symbol: "COUP",
  url: "https://coup.farm/",
  description: "The Coup Farm is a decentralized yield farming project running on Avalanche. Built upon proven features and logic to generate solid yields and passive income.",
  chain: "Avalanche",
...
},
{
  ...
  description: "Caribou Finance is a new DeFi project on Fantom featuring low emission rate, low supply, harvest lock & layered farming later on to our platform.",
  chain: "Fantom",
...
},
{
  ...
  description: "AVAVIKING Finance is the next generation of decentralised finance (DeFi) and yield farm application on Avalanche blockchain.",
  chain: "Avalanche",
...
},
{
  ...
  description: "GrassLand Finance is a progressive layered yield farming protocol on the Polygon network which, ultimately, aims to introduce creative features that enable past layers to remain relevant beyond being used to farm future layers.",
  chain: "Polygon",
...
},
{
  ...
  description: "Mirai is a Polygon yield farming project with a low emission rate, high yields and a limited cap of 30,000 MIRAI tokens.",
  chain: "Polygon",
...
},
{
  ...
  description: "LemonSwap is a new DeFi project on BSC featuring a deflationary token model with a unlimited supply of LEMON tokens and yield farming.",
  chain: "Binance",
...
},
{
  ...
  description: "Zeu$ Finance is a sustainable, decentralized, value-oriented, multi-token ecosystem on the newly born Cronos Network",
  chain: "Cronos",
...
},
{
  ...
  description: "Valkyrie Protocol is a DApp activation protocol that is designed to help protocols launch effectively.",
  chain: "Terra",
...
},
{
  ...
  description: "Avalps is a decentralized reserve currency protocol available on the Avalanche Network based on the $BLANC token",
  chain: "Avalanche",
...
},
{
  ...
  description: "High security crosschain Yieldfarming DAPP and crypto platform running on the Binance Smart Chain (BSC) and Polygon chain using the ApeSwap Exchange.",
  chain: "Binance",
...
},
{
  ...
  symbol: "CYS",
  url: "https://cykura.io",
  description: "Cykura is the first CLMM on Solana that solves the problem of capital inefficiency and maximizes returns for liquidity providers while offering a smooth and fast experience for traders.",
  chain: "Solana",
...
},
{
  ...
  description: "The $PIGGY algorithmic token serves as the backbone of a rapidly growing ecosystem aimed towards bringing liquidity and new use cases to the Avalanche network.",
  chain: "Avalanche",
...
},
{
  ...
  description: "Baker Guild $BREAD is a decentralized autonomous organization (DAO) & new yield farming protocol on Fantom Opera.",
  chain: "Fantom",
...
},
{
  ...
  description: "NiiFi is built on nahmii, a patent-pending scaling technology allowing for instant finality, low cost and predictable gas/transaction fees, interoperability, and composability. NiiFi has been built with the future in mind.",
  chain: "Nahmii",
...
},
{
  ...
  description: "Friktion is a crypto-asset portfolio management platform, built to perform across market cycles. Volts, Friktion’s native structured products, offer sustainable income generation and volatility yield strategies. Designed for individuals and DAOs.",
  chain: "Solana",
...
},
{
  ...
  description: "Trick or Treat Farm aims to provide a safe and fortuitous place for newcomers and veterans alike to increase the yields on cryptocurrency tokens deposited in the farm.",
  chain: "Fantom",
...
},
{
  ...
  url: "https://defichain.com",
  description:
    "Over-collateralized loans on DefiChain.",
  chain: "DefiChain",
  logo: `${baseIconsUrl}/defichain.jpg`,
  audits: "2",
  audit_note: null,
...
},
{
  ...
  description: "MetaReserve is a Decentralized Reserve Currency Protocol that aims to take the lead in setting a new benchmark in the wild west world of Decentralized Finance (DeFi).",
  chain: "Binance",
...
},
{
  ...
  description: "Tropical Finance is a state of the art DEX and yield farming application on SmartBCH Chain with unique features which offers its investors brand new ways to maximize APRs.",
  chain: "SmartBCH",
...
},
{
  ...
  description: "Whale.loans is a venture focused on designing a scalable and defendable ecosystem that removes the complexity in and around DeFi and distributes value to its users. In layman’s terms, we are creating an “easy button” for a better user experience.",
  chain: "Binance",
...
},
{
  ...
  twitter: "MojitoSwap",
  forkedFrom: ["Uniswap"],
  audit_links: ["https://github.com/MojitoFinance/mojito-swap-farm/blob/main/doc/PeckShield-Audit-Report-Mojito-v1.0.pdf"],
  listedAt: 1641194662,
},
{
  id: "1182",
  ...
  description: "ChargeDeFi is a combination of an Algorithmic Stablecoin with rebase mechanics. With Charge the project aims to lay the foundations of a sustainable ecosystem on the Binance smart chain. It features rebasing mechanics to protect the value of the $Static token and keep it pegged to $1 BUSD.",
  chain: "Binance",
...
},
{
  ...
  description: "CyberTime Finance is a decentralized application platform designed to be an ecosystem containing farming, DAO, NFT, Mystery Boxes and a game called Daopolis. The project runs on Binance Smart Chain (BSC).",
  chain: "Binance",
...
},
{
  ...
  description: "On-chain spot and margin trading protocol for crypto assets. Swap hundreds of tokens with up to 5x leverage",
  chain: "Ethereum",
...
},
{
  ...
  symbol: "RARE",
  url: "https://rare.fyi",
  description: "Rarify is a collection of defi applications that lets anyone earn RARE COIN equally and virtually free. Two Rare coins are created and distributed every day: One is equally distributed to the daily Claimers and one is weighted distributed to the weekly Stakers.",
  chain: "xDai",
...
},
{
  ...
  description: "Galatea cash is the first algorithmic stablecoin protocol designed to follow the price of CRO running on the Cronos Chain.",
  chain: "Cronos",
...
},
{
  ...
  description: "PolkaEx is a cross-chain Dex and Launchpad on Polkadot, using Astar Network to provide higher TPS and lower transaction fees.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Cross-chain, cross-layer yield optimizer. Strategy hub powered by and for a cross-layer, cross-chain future for DeFi’s continuous growth.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Chronicle is both a publisher and marketplace for officially licensed digital collectables, also more commonly known as NFTs",
  chain: "Aurora",
...
},
{
  ...
  description: "Predictcoin is an all-in-one price prediction DAO. Stake, Farm, Vote and Predict the prices of various crypto assets.",
  chain: "Binance",
  ...
  audit_links: ["https://github.com/TechRate/Smart-Contract-Audits/blob/main/August/Predictcoin%20Full%20Smart%20Contract%20Security%20Audit.pdf"],
  listedAt: 1641513916,
},
{
  id: "1206",
  ...
  description: "WagmiDAO is the first multichain reserve-backed decentralised exchange (RDEX). It’s focused on continuously growing its own Treasury and the value of its native token.",
  chain: "Harmony",
...
},
{
  ...
  description: "The first decentralized passive income and prize savings protocol on the Terra blockchain that lets you win by saving.",
  chain: "Terra",
  ...
  audit_links: ["https://github.com/oak-security/audit-reports/blob/master/Ink%20Protocol/2021-09-15%20Ink%20-%20Audit%20Report.pdf"],
  listedAt: 1641534878,
},
{
  id: "1210",
...
},
{
  ...
  symbol: "THO",
  url: "https://thorus.fi/",
  description: "Thorus is an all in one cross-chain DeFi Platform with an adaptable treasury system, and a token holder first approach. All protocol functions are designed to reinforce this mentality",
  chain: "Avalanche",
...
},
{
  ...
  description: "OVR is an AR, NFT Metaverse platform that layers over the entire world. Imagine, create & sell experiences for B2B + B2C.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Sierra is a decentralized reserve currency protocol available on the Avalanche Network based on the SRA token.",
  chain: "Avalanche",
...
},
{
  ...
  description: "KillSwitch is a smart yield aggregator, users are free to unstake, withdraw Liquidity Position from their funds and sell their coins instantly in one click.",
  chain: "Binance",
...
},
{
  ...
  description: "The protocol for yield generation and DEX trading, created by & for the DeFi community. Providing synthetic assets: USD and BTC pegged tokens.",
  chain: "Polygon",
...
},
{
  ...
  description: "Photon is a fork of an Olympus DAO (decentralized reserve currency platform) that has a big advantage, it lives on Binance Smart Chain (BSC).",
  chain: "Binance",
...
},
{
  ...
  description: "SashimiDAO is a decentralized reserve currency protocol available on the Avalanche Network based on the SASHI token",
  chain: "Avalanche",
...
},
{
  ...
  description: "Welnance is a protocol on the Binance Smart Chain that establishes money markets, which are pools of assets with algorithmically derived interest rates, based on the supply and demand for the asset.",
  chain: "Binance",
...
},
{
  ...
  description: "VESQ is a decentralized reserve currency protocol available on the Polygon (MATIC) Network based on the VSQ token.",
  chain: "Polygon",
...
},
{
  ...
  description: "TerraFloki is the 2nd Decentralised Exchange (DEX) launched on Terra. Main utility of TerraFloki DEX is trading $TFLOKI and NFT Tickets (needed to ensure the NFT-as-a-Subscription model of NFT distribution). NFTs are essential building blocks of the Flokiverse - an emerging P2E ecosystem with an open economy.",
  chain: "Terra",
...
},
{
  ...
  description: "Creditum is a lending & borrowing protocol that allows users to mint cUSD, a stablecoin pegged at $1, by supplying collateral.",
  chain: "Fantom",
...
},
{
  ...
  description: "Money Markets DeFi platform for lenders and borrowers, that also features own AMM, IDO Launchpad, and NFT Marketplace with Governance AGL token.",
  chain: "Cronos",
  ...
  twitter: "agiledefi",
  audit_links: ["https://github.com/solidproof/smart-contract-audits/blob/main/SmartContract_Audit_Solidproof_AgileFinance.pdf"],
...
},
{
  ...
  description: "Creating the foundation for innovative financial services and investment. They build and support services that contribute to the growth and security of #DeFi",
  chain: "Binance",
...
},
{
  ...
  description: "Duneswap is an Automated Market Maker/Decentralized Exchange native to Oasis Emerald ParaTime Network. DUNE is the native token to the platform which can be attained by farming/staking or trading for.",
  chain: "Oasis",
...
},
{
  ...
  description: "SleepEarn Finance is a Decentralized, Yield Optimizer platform on KardiaChain that allows its users to earn compound interest on their crypto holdings.",
  chain: "Kardia",
...
},
{
  ...
  description: "Crabada is an idle game, which means that you'll be able to play it anytime and anywhere with minimal disruption to your everyday life. Crabada is bringing forth a new revolution in play-and-earn games with its unique PvP (Player Versus Player)-infused idle gameplay.",
  chain: "Avalanche",
...
// },
{
  ...
  description: "One of The first algorithmic stablecoin on Avalanche C Chain, pegged to the price of 1 AVAX via seigniorage.",
  chain: "Avalanche",
...
*/
{
  ...
  description: "Proof Of Humanity is launching with Democracy Earth's UBI Token. Our verified humans will be the first fully decentralized UBI recipients. We also launched a sustained liquidity provider rewards program. You can provide liquidity in ETH/UBI and DAI/UBI curves on Uniswap and farm a share of UBI rewards minted over the course of a year.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Delta is an on-chain options layer which utilizes a combination of liquidity standards to reduce premiums and offer competitive options prices.",
  chain: "Ethereum",
...
},
{
  ...
  description: "ThetaSwap is the first decentralized exchange built on Theta blockchain, using an open-source smart contract system built based on Automated Market Maker logic similar to that of Uniswap.",
  chain: "Theta",
...
},
{
  ...
  description: "DarkCrypto Finance is the first ecosystem running around an algorithmic token pegged to CRO on Cronos chain. DarkVerse will be our ecosystem using DARK as the main token. It contains: DeFi App (Vaults, Stablecoin swap, lending), GameFi, NFT Apps, Betting DApps, MetaVerse applications",
  chain: "Cronos",
  ...
  forkedFrom: ["Tomb Finance"],
  audit_links: ["https://github.com/peckshield/publications/blob/master/audit_reports/PeckShield-Audit-Report-DarkCrypto-v1.0.pdf"],
  listedAt: 1642192171,
},
{
  id: "1262",
...
},
{
  ...
  description: "SmartPad is the first launchpad platform of its kind. Our vision is to create a multi-cross-chain launchpad, enabling participation in the IDOs occurring on one blockchain while using the assets from another chain.",
  chain: "Ethereum",
...
},
{
  ...
  description: "SmartDex is as the DEX on SmartBCH that is using very potent mechanisms behind the scenes that rewards holders of dSMART, through solo staking and revenue accrual models.",
  chain: "smartBCH",
...
},
{
  ...
  symbol: "X",
  url: "https://x.xyz",
  description: "X is a multichain decentralised NFT marketplace that is owned and operated by the NFT community. Governance is provided by the X DAO with voting rights given to token holders.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Yield aggregator with interest bearing tokens and extra functions like casino & collateral. The system is specifically edited to prevent whales influencing the price.",
  chain: "Avalanche",
...
},
{
  ...
  description: "We aim to connect DeFi with the real world. paprprintr at its core, is an algorithmic stablecoin driven by elastic expansion and burn.",
  chain: "Binance",
...
},
{
  ...
  description: "TCORE is a non-inflationary cryptocurrency based on cVault (CORE) source code, that is designed to execute profit-generating strategies autonomously with a completely decentralized approach.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Rubic, One-Click Cross-Chain Aggregator allows users to swap more than 15,000 assets between 13 major blockchains, with a simple and intuitive UI. Rubic's protocol offers easy trading for more than 15,000+ assets across Polygon, BNB Smart Chain, Ethereum, Avalanche, Fantom, Arbitrum, Gnosis, Fuse,  Celo, Optimism, Moonbeam, OKC and Cronos networks, using our custom and unique Cross-Chain Protocol.",
  chain: "Ethereum",
...
},
{
  ...
  description: "BENT is a staking and farming platform that enhances your curve to elevate your yields. By the people for the people.",
  chain: "Ethereum",
...
},
{
  ...
  description: "Paladin DAO is the decentralized reserve currency protocol available on the BSC (Binance Smart Chain) based on the PD token.",
  chain: "Binance",
...
},
{
  ...
  description: "BurgerSwap is the first cross-chain aggregator combining rates and prices from the leading DEXs and CEXs; By combining the switch protocol, BurgerSwap, has integrated CEXs, DEXs, and DeFi deals into a single platform",
  chain: "Binance",
...
},
{
  ...
  description: "The world's best staking ecosystem is here. 8% fixed-rate APR. Daily bitcoin divs. Curated token launchpad. Community voting. NFT stakes, and more! This is $AXN",
  chain: "Polygon",
...
},
{
  ...
  symbol: "ELITE",
  url: "https://ftm.guru",
  description: "A Multi-faceted growth hacker for indie projects, ftm.guru provides numerous Tools, Services and niche utility-applications to users and bespoke product customization, liquidity enhancement and data analytics products to De-Fi innovators",
  chain: "Fantom",
...
},
{
  ...
  audit_links: ["https://github.com/peckshield/publications/blob/master/audit_reports/PeckShield-Audit-Report-Buffer-v1.0.pdf"],
  oracles: ["Chainlink"],
  forkedFrom: [],
  listedAt: 1642780144,
},
{
  ...
  description: "WeBribe Dao is founded with the single objective to acquire governance power over ve(3,3) AMM. Participants can farm $VBRB (https://twitter.com/search?q=%24VBRB&src=cashtag_click) tokens by depositing various assets",
  chain: "Fantom",
...
},
{
  ...
  description: "Moremoney is a protocol for borrowing stablecoin while receiving yield on LP tokens and other collateral assets.",
  chain: "Avalanche",
...
},
{
  ...
  description: "Epsylon.finance is a single asset, multi-strategy yield generation. Epsylon divides yield vaults by a risk profile (Safe, Moderate, Aggressive), simplifying the user experience and maximizing profits for each risk.",
  chain: "Fantom",
...
},
{
  ...
  description: "NoahArkDAO is a fork of Olympus on multi-chain, starting from Avalanche. Designed to provide backup for Game-Fi crypto with stablecoins and Proof of Liquidity.",
  chain: "Avalanche",
...
},
{
  ...
  description: "Cesta Finance is a next generation DAO reserve currency on Avalanche, combining the best of yield farming index funds and the 'protocol-owned-liquidity' token model of DeFi 2.0.",
  chain: "Avalanche",
...
},
{
  ...
  description: "Comfy Money is an algorithmic stablecoin on Harmony, intended to be pegged to the price of $ONE via the seigniorage shares model.",
  chain: "Harmony",
...
},
{
  ...
  description: "One of the purest meme tokens on the market. We aren't backed by gold, silver nor cashmere. We are however backed by our Metamorphosis, our best secret for now.",
  chain: "Fantom",
...
},
{
  ...
  description: "The $STOMB algorithmic token serves as the backbone of a rapidly growing ecosystem aimed towards bringing liquidity and new use cases to the Avalanche network.",
  chain: "Avalanche",
...
},
{
  ...
  symbol: "BELUGA",
  url: "https://beluga.fi",
  description: "A cross-chain yield optimizer on #Fantom and #0xPolygon with innovative strategies to earn the best yields.",
  chain: "Fantom",
...
},
{
  ...
  description: "Unizen provides a simple interface that caters to all trading personas to acquire any asset, for the best fees across a multitude of liquidity pools",
  chain: "Ethereum",
...
},
{
  ...
  description: "Building upon the success of Bouje Finance, Vive La Bouje is a second-generation yield farming platform made on the Fantom Blockchain, aiming to have positive and steady price action. Utilizing a new-age system called APR reset (inspired by Swift Finance).",
  chain: "Fantom",
...
},
{
  ...
  symbol: "WARP",
  url: "https://warp.bond/",
  description: "Warp is a new GameFi protocol, combining NFT starships, multiple staking pools, and deflationary tokenomics.",
  chain: "Polygon",
...
},
{
  ...
  description: "Devil Finance is a Decentralized Yield Optimizer platform that allows its users to earn compound interest on their crypto holdings",
  chain: "Fantom",
  ...
  audit_links: ["https://github.com/solidproof/smart-contract-audits/blob/main/SmartContract_Audit_Solidproof_Devil.pdf"] ,
  listedAt: 1643804913,
},
{
  id: "1344",
  ...
  description: "FATFIRE is a new Smart DeFi Rewards Token & Yield Generator on the Fantom Network - with ZERO deposit fees.",
  chain: "Fantom",
...
},
{
  ...
  description: "The $OWL algorithmic token serves as the backbone of a rapidly growing ecosystem aimed towards bringing liquidity and new use cases to the Moonriver network.",
  chain: "Moonriver",
...
},
{
  ...
  description: "Astral Financial is the first native yield optimizer on Moonbeam. We offer competitively low fees and astronomical APYs.",
  chain: "Moonbeam",
...
},
{
  ...
  description: "DoE is a passion project that creates an alternative to CryptoPunks, it is inspired by both DOGE and SHIB and has 10,000 unique collectable characters for the meme coin community",
  chain: "Ethereum",
...
},
{
  ...
  description: "The $aHYPE Social Index reflects the performance of a portfolio selected from the most socially active cryptocurrencies in the past 30 days, using Heimdall Social Score data.",
  chain: "Avalanche",
...
},
{
  ...
  description: "MELD is the first DeFi, non-custodial, banking protocol. You can securely lend & borrow both crypto and fiat currencies with ease and stake your MELD tokens for APY.",
  chain: "Cardano",
...
},
{
  ...
  description: "ONI.exchange is an intelligent decentralized exchange running on Binance Smart Chain, with AMM, NFTs, and Yield Farming.",
  chain: "Binance",
...
},
{
  ...
  description: "Swap on Narwhalwap are a simple way to trade one BEP-20 token for another via automated liquidity pools. The liquidity provided to the exchange comes from Liquidity Providers who stake their tokens in Pools.",
  chain: "Binance",
...
},
{
  ...
  description: "WOWswap is a decentralized leveraged trading protocol built on Ethereum, Solana, Arbitrum, Avalanche, Binance Smart Chain, IoTeX, Polygon and HECO Chain.",
  chain: "Binance",
...
},
{
  ...
  description: "We are Ripae Finance, a cross-chain algorithmic stable coin pegged to each native chain we are deployed on. Ripae Finance’s full focus is to build a true cross-chain algorithmic stable coin protocol that is stabilized with true use-cases all around the DeFi Ecosystem. Available on multiple EVM chains, our core token $PAE is fully cross-chain using Multichain bridge.",
  chain: "Fantom",
...
},
{
  ...
  language: "Solidity",
  audit_links: ["https://rugdoc.io/project/superman-swap/",
                "https://jagosafer.io/superman-swap"],
  listedAt: 1644364311,
},
{
  id: "1373",
...
},
{
  ...
  description: "SaharaExchange is a DEX on Oasis Emerald ParaTime that rewards holders of ANKH, through solo staking and pool staking.",
  chain: "Oasis",
...
},
{
  ...
  description: "MAIA is the first decentralized community owned reserve currency in Metis Andromeda. Including a growing ecosystem of products - starting with Hermes Protocol - and an array of treasury investment strategies.",
  chain: "Metis",
...
},
{
  ...
  description: "Soluna is a protocol for composable stable assets designed to bridge Anchor Protocol's high-yield savings to Solana.",
  chain: "Terra",
...
},
{
  ...
  symbol: "DEUS",
  url: "https://deus.finance",
  description: "World-first decentralized bilateral OTC derivatives platform. Enabling next-gen DeFi giving users & developers unlimited access to global markets",
  chain: "Ethereum",
...
},
{
  ...
  description: "Parassets such as PUSD, PETH are generated by protocol collateral and anchor the underlying asset with an intrinsic value of 1:1",
  chain: "Ethereum",
...
},
{
  ...
  twitter: "polyquail",
  language: "Solidity",
  audit_links: ["https://paladinsec.co/projects/polyquail-layer-3-chk/" ,
...
},
{
  ...
  description: "Project X, was formed by the 100 Founders - a mature group of corporate executives who are supported by highly capable and intelligent young energy to create, nurture, and grow a node type project to be massively successful.",
  chain: "Avalanche",
...
},
{
  ...
  description: "A decentralised liquidity pool owned by you, powered by our Basis Trade Engine. Next-level returns. Delta-neutral yield. Real-time insights.",
  chain: "Solana",
...
},
{
  ...
  description: "MyMine - this is not just a farm! It will bring together and help projects such as Waterfall, Knights of Fantom, Moneyrain",
  chain: "Fantom",
...
},
{
  ...
  description: "Gotchi Vault allows users to deposit their GHST and Aavegotchis into the Vault smart contracts to be collectively managed.",
  chain: "Polygon",
...
// },
{
  ...
  symbol: "ARROWS",
  url: "https://www.coconuts.finance/",
  description: "Cupid Farm is a new yield farming & yield aggregator protocol, powered by the Fantom Network. Our main focus is to deliver a safe, sustainable farm with a strong and active community!",
  chain: "Fantom",
...
},
{
  ...
  description: "The Stable Swap owned by the Metis Community. Drachma offers Curve style hyper efficient, low slippage swaps for both pegged and unpegged assets",
  chain: "Metis",
