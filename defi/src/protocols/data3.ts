...
const data3: Protocol[] = [
  ...
  */
  ...
  },
  {
    ...
    description: "EDE (BASE) is an innovative decentralized trading platform built for perpetual and spot trading on the Ethereum L2 Basechain",
    chain: "Base",
    logo: `${baseIconsUrl}/ede(base).png`,
    audits: "2",
    audit_note: null,
    gecko_id: null,
    cmcId: null,
