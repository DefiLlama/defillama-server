...
return getClosestDayStartTimestamp(dailyTvls.Items![0].SK ?? Math.round(Date.now()/1000))
}
...
const main = async()=>{
    ...
    while(true){
        ...
        await storeTvl(timestamp, ethereumBlock, chainBlocks, protocol, {}, 4, getCoingeckoLock, false, false);
