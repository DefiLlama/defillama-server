...
const CG_TOKEN_API = `https://pro-api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=100&page=<PLACEHOLDER>&include_rehypothecated=true&x_cg_pro_api_key=${process.env.CG_KEY}`;
